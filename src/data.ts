...
export const lineChartBoxProduct = {
  ...
  chartData: [
    ...
    { name: "Win", products: 700 },
    { name: "Thu", products: 400 },
    { name: "Fri", products: 500 },
    { name: "Sat", products: 600 },
  ],
};
...
// These are the Data for the Users inserted in the user data table(Rows)
